    ...
    AI-Powered Health Assistant
                ...
                {!submitted && (
                    <motion.div className="z-0 flex flex-col md:flex-row gap-6 justify-center items-center mt-10 px-4">
                        ...
                        >
                            <HeartPulse size={36} className="text-white mb-3" />
                            <h2 className="text-xl font-semibold text-white">Why Choose Our Platform?</h2>
                            <p className="text-white mt-2">
                                We offer AI-driven medical assistance, real-time ambulance booking, and a comprehensive digital health record system.
                            </p>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            whileHover={{ scale: 1.05 }}
                        >
                            <Bell size={36} className="text-white mb-3" />
                            <h2 className="text-xl font-semibold text-white">Feature Highlight: Medicine Reminder</h2>
                            <p className="text-white mt-2">
                                Never miss a dose! Our AI-powered system sends reminders for your medication based on your prescription schedule.
                            </p>
                        </motion.div>
                    </motion.div>
                )}
